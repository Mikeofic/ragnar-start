      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div class="animate-on-scroll" style="animation-delay: 0.1s;">
            <div class="bg-red-50 dark:bg-red-900/20 p-8 rounded-2xl border border-red-200 dark:border-red-800">
              <div class="text-center mb-6">
                <div class="w-16 h-16 bg-red-100 dark:bg-red-800 rounded-full mx-auto flex items-center justify-center">
          ...
          <div class="animate-on-scroll" style="animation-delay: 0.2s;">
            <div class="bg-gradient-to-br from-primary-50 to-green-50 dark:from-primary-900/30 dark:to-green-900/30 p-8 rounded-2xl border border-primary-200 dark:border-primary-800 relative overflow-hidden">
              ...
              <div class="text-center mb-6 relative">
                <div class="w-16 h-16 bg-gradient-to-r from-primary-500 to-green-500 rounded-full mx-auto flex items-center justify-center">
