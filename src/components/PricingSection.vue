        ...
        <div class="animate-on-scroll pricing" style="animation-delay: 0.2s;">
          <div class="relative">
            ...
            <div class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 tag z-20">
              <span class="bg-gradient-to-r from-primary-500 to-green-500 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-lg whitespace-nowrap">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100 dark:border-gray-700 relative z-10 overflow-hidden gradient-border-animated">
              ...
              <div class="relative text-center">
                ...
                <div class="bg-gradient-to-r from-primary-50 to-green-50 dark:from-primary-900/30 dark:to-green-900/30 p-6 rounded-2xl mb-8">
                  <p class="text-lg text-gray-700 dark:text-gray-300 mb-2 leading-relaxed max-w-prose mx-auto [text-wrap:balance]">
                  ...
                  <p class="text-xl font-semibold text-gray-900 dark:text-white leading-relaxed max-w-prose mx-auto [text-wrap:balance]">
                ...
                <a 
                  ...
                  target="_blank"
                  class="btn-whatsapp text-lg animate-border-glow group inline-flex text-center [text-wrap:balance] sm:whitespace-nowrap"
                >
        ...
        <div class="animate-on-scroll mt-12 text-center" style="animation-delay: 0.4s;">
          <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 max-w-2xl mx-auto">
            <div class="flex items-center justify-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-bold text-gray-900 dark:text-white tracking-tight [text-wrap:balance]">
